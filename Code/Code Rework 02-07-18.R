...
setwd("/Users/devjyw/Dropbox/Research/DesignedMissingness/")
...
Daily <- read.csv('/Users/devjyw/Dropbox/Research/DesignedMissingness/Daily with Tox.csv')
...
for (i in 1:200) {
  ...
  X <- X[rep(row.names(X), 45),] #Repeat each row 45 times, all curent variables are time invariant
