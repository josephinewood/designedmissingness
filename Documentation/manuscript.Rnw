...
splitplot <- ggplot(datmelt, aes(Question, Day, fill=color)) + geom_raster() + scale_fill_manual(values = cols)  + theme(axis.title.x = element_blank(),panel.background = element_rect(fill = NA)) + labs(y = "Day",fill="Block") + scale_y_reverse() + theme(legend.title=element_blank(),legend.position="none")
...
<<warning=FALSE,echo=FALSE>>=
cols <- c("Missing" = "red", "Observed" = "skyblue3")
alternatesplitplot <- ggplot(datmelt, aes(Question, Day, fill=color)) + geom_raster() + scale_fill_manual(values = cols)  + theme(axis.title.y = element_blank(), axis.title.x = element_blank(),panel.background = element_rect(fill = NA)) + labs(x = "Questions Asked",fill="Block") + scale_y_reverse() + theme(legend.title=element_blank(),legend.position="none") 
...
<<echo=FALSE>>=
cols <- c("Missing" = "red", "Observed" = "skyblue3")
waveplot <-  ggplot(datmelt, aes(Question, Day, fill=color)) + geom_raster() + scale_fill_manual(values = cols)  + theme(axis.title.x = element_blank(), axis.title.y = element_blank(),panel.background = element_rect(fill = NA)) + labs(fill="Block") + scale_y_reverse() + theme(legend.title=element_blank(),legend.position="none")
@
...
#plots <- grid.arrange(splitplot, alternatesplitplot, waveplot, ncol=3, bottom=textGrob("x axis title", gp=gpar(fontsize=22)))

#grid_arrange_shared_legend(plots,position="bottom")

gg <- grid_arrange_shared_legend(splitplot, alternatesplitplot, waveplot, ncol=3, position="top")
grid.arrange(gg,bottom=textGrob("Questions Asked"))
