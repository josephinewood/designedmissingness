...
load("~/GitHub/designedmissingness/Results/tables20180509_60_1_med.RData")
med <- d

load("~/GitHub/designedmissingness/Results/tables20180509_60_1_low.RData")
low <- d

library(xtable)
print(xtable(cbind("","","",rbind(low[[1]],med[[1]],high[[1]],low[[2]],med[[2]],high[[2]],low[[3]],med[[3]],high[[3]])),digits= 3),type="latex", comment = FALSE)
