...
<<misslow, fig.cap = "Low missingness", echo = FALSE, message = FALSE>>=
require(gridExtra)
...
<<echo=FALSE>>=
d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_high.RData")
high <- d

d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_med.RData")
med <- d

d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_low.RData")
low <- d
...
d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_high_hightime1.RData")
high <- d

d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_med_hightime1.RData")
med <- d

d <- file("~/GitHub/designedmissingness/Results/tables20180509_60_1_low_hightime1.RData")
low <- d
