...
\caption{\label{tab:unnamed-chunk-2}\label{tab:prelim} Primary Results (N = 60)}
\centering
\resizebox{\linewidth}{!}{\begin{tabular}[t]{l|l|r|l|r|l|r}
\hline
Scenario & Parameter & Bias & Pct Bias & MSE & Coverage & CI Length\\
\hline
 & $\gamma_0$ & 0.042 & -1.86\% & 0.018 & 98.8\% & 0.700\\

 & $\beta_1$ & -0.103 & -36.45\% & 0.871 & 95.4\% & 3.040\\

 & $\beta_2$ & 0.008 & 1.26\% & 0.024 & 93.4\% & 0.585\\

\multirow{-4}{*}{\raggedright\arraybackslash Primary Analysis (n = 60)} & $\beta_3$ & 0.000 & -0.83\% & 0.000 & 94.2\% & 0.017\\
\cline{1-7}
 & $\gamma_0$ & 0.014 & -0.59\% & 0.008 & 98.4\% & 0.424\\

 & $\beta_1$ & -0.038 & -13.5\% & 0.135 & 95.2\% & 1.384\\

 & $\beta_2$ & 0.006 & 0.86\% & 0.007 & 94.4\% & 0.319\\

\multirow{-4}{*}{\raggedright\arraybackslash Increased Sample Size (n = 120)} & $\beta_3$ & 0.000 & -0.87\% & 0.000 & 95.3\% & 0.012\\
\cline{1-7}
 & $\gamma_0$ & 0.044 & -1.91\% & 0.018 & 98.8\% & 0.700\\

 & $\beta_1$ & -0.067 & -23.67\% & 0.298 & 95.8\% & 2.001\\

 & $\beta_2$ & 0.007 & 1.11\% & 0.024 & 93.5\% & 0.585\\

\multirow{-4}{*}{\raggedright\arraybackslash Low Inter-Survey Correlation (n = 60)} & $\beta_3$ & 0.000 & -1.17\% & 0.000 & 94\% & 0.017\\
\cline{1-7}
 & $\gamma_0$ & -0.020 & 0.44\% & 0.114 & 96.2\% & 1.368\\

 & $\beta_1$ & -6.781 & -4815.84\% & 136.550 & 96.6\% & 88815.966\\

 & $\beta_2$ & 0.014 & 4.54\% & 0.047 & 95.7\% & 0.832\\

\multirow{-4}{*}{\raggedright\arraybackslash High Time Effect (n = 60)} & $\beta_3$ & 0.000 & -0.98\% & 0.000 & 94.5\% & 0.039\\
\hline
\end{tabular}}
\end{table}
