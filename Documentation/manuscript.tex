...
>>>>>>> f0edf972073b36497a93dea6679bfe4a34f218f2
...
\begin{alltt}
\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_high.RData"}\hlstd{)}
\hlstd{high} \hlkwb{<-} \hlstd{d}

\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_med.RData"}\hlstd{)}
\hlstd{med} \hlkwb{<-} \hlstd{d}

\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_low.RData"}\hlstd{)}
\hlstd{low} \hlkwb{<-} \hlstd{d}

\hlkwd{library}\hlstd{(xtable)}
\hlkwd{print}\hlstd{(}\hlkwd{xtable}\hlstd{(}\hlkwd{cbind}\hlstd{(}\hlstr{""}\hlstd{,}\hlstr{""}\hlstd{,}\hlstr{""}\hlstd{,}\hlkwd{rbind}\hlstd{(low[[}\hlnum{1}\hlstd{]],med[[}\hlnum{1}\hlstd{]],high[[}\hlnum{1}\hlstd{]],low[[}\hlnum{2}\hlstd{]],med[[}\hlnum{2}\hlstd{]],high[[}\hlnum{2}\hlstd{]],low[[}\hlnum{3}\hlstd{]],med[[}\hlnum{3}\hlstd{]],high[[}\hlnum{3}\hlstd{]])),}\hlkwc{digits}\hlstd{=} \hlnum{3}\hlstd{),}\hlkwc{include.rownames}\hlstd{=}\hlnum{FALSE}\hlstd{)}
\end{alltt}
\begin{verbatim}
## % latex table generated in R 3.5.0 by xtable 1.8-2 package
## % Tue May 15 15:43:01 2018
## \begin{table}[ht]
## \centering
...
\end{verbatim}
\begin{alltt}
\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_high_hightime1.RData"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file '/Users/gregorymatthews/Dropbox/designedMissingnessGit/Results/tables20180509\_60\_1\_high\_hightime1.RData', probable reason 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readChar(con, 5L, useBytes = TRUE): cannot open the connection}}\begin{alltt}
\hlstd{high} \hlkwb{<-} \hlstd{d}

\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_med_hightime1.RData"}\hlstd{)}
\hlstd{med} \hlkwb{<-} \hlstd{d}

\hlkwd{load}\hlstd{(}\hlstr{"~/Dropbox/designedMissingnessGit/Results/tables20180509_60_1_low_hightime1.RData"}\hlstd{)}
\hlstd{low} \hlkwb{<-} \hlstd{d}
...
## "" & "" & "" & Coverage & Bias & MSE & FMI \\ 
##   \hline
